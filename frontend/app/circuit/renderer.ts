...
// Nous avons eu recours a l'IA pour nous aider a implementer correctement le renderer
// Cette classe s'occupe de convertir des donnees en quelque chose de tangible visuellement
